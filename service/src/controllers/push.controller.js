...
async function checkAccess(req, res) {
    const { param1, param2, param3, param4, param5, param6, param7, param8, user_address } = req.params;
    const borderString = `${param1},${param2},${param3},${param4}|${param5},${param6},${param7},${param8}`;

    var requestJSON = {
        query: "query GetUserByIdAndBorderString($userId: ID!, $borderString: String!) {\n  user(id: $userId) {\n    id\n    totalDistance\n    lastBorderAvgLat\n    lastBorderAvgLng\n    borderHistory(where: {border_string: $borderString}) {\n      id\n      border_latitudes\n      border_longitudes\n      border_string\n      border_timestamp\n      blockTimestamp\n    }\n  }\n}",
        variables: {
            userId: user_address, // "0xa8003509743746eeeac2f978253a502edc535d44", // TODO: change this to the user's address
